class CartsController < ApplicationController
  ...
  def update
    ...
    if @order.update(order_params)
      ...
      quantities = @order_items

      OrderMailer.order_email(company_name, customer_first_name, customer_last_name, customer_email, phone_number, customer_billing_address, customer_billing_postcode, customer_billing_city, customer_billing_country, vat_number, special_request, quantities).deliver
